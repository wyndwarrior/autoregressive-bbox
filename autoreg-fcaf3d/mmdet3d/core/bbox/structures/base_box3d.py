...
class BaseInstance3DBoxes(object):
    ...
    @classmethod
    def overlaps(cls, boxes1, boxes2, metric):
        ...
        Args:
            boxes1 (:obj:`BaseInstanceBoxes`): Boxes 1 contain N boxes.
            boxes2 (:obj:`BaseInstanceBoxes`): Boxes 2 contain M boxes.
            metric (str, optional): metric of iou calculation. Defaults to 'iou'.
        ...
        assert metric in ['iou', 'iop', 'iog'], metric
        ...
        if metric == 'iou':
            ...
            iou3d = overlaps_3d / torch.clamp(volume2, min=1e-8)
