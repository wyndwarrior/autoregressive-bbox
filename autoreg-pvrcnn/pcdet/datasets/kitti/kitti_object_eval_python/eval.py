...
def calculate_iou_partly(gt_annos, dt_annos, metric, criterion, num_parts=50):
    ...
    for num_part in split_parts:
        ...
        if metric == 0:
            ...
            dt_boxes = np.concatenate(
                [loc, dims, rots[..., np.newaxis]], axis=1)
            overlap_part = d3_box_overlap(gt_boxes, dt_boxes, criterion=criterion).astype(
                np.float64)
        else:
...
def eval_class(gt_annos,
    ...
    rets = calculate_iou_partly(dt_annos, gt_annos, metric, criterion, num_parts)
...
def do_eval(gt_annos,
    ...
    ret = eval_class(gt_annos, dt_annos, current_classes, difficultys, 0,
                     min_overlaps, criterion, compute_aos)
...
def get_official_eval_result(gt_annos, dt_annos, current_classes, criterion, PR_detail_dict=None):
    ...
    mAPbbox, mAPbev, mAP3d, mAPaos, mAPbbox_R40, mAPbev_R40, mAP3d_R40, mAPaos_R40 = do_eval(
        gt_annos, dt_annos, current_classes, min_overlaps, criterion, compute_aos, PR_detail_dict=PR_detail_dict)
